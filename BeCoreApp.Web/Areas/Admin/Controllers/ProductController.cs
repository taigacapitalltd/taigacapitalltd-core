...
namespace BeCoreApp.Areas.Admin.Controllers
{
    public class ProductController : BaseController
    {
        ...
        {
            var tags = _productService.GetListTagByType(CommonConstants.ProductTag);
            ViewBag.Tags = new SelectList(tags, "Id", "Name");

            var productTypes = _productService.GetAllProductType();
        ...
        {
            var model = _productService.GetAllPaging("", "", keyword, blogCategoryId, page, pageSize);
