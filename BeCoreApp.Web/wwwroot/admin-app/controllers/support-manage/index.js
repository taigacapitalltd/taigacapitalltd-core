var SupportManageController = function () {
    ...
    function validateData() {
        ...
        dataSupport = {
            Id: +($('#hidId').val()),
            ResponseContent: CKEDITOR.instances.txtResponseContent.getData()
        }

        var isValid = true;

        if (!dataSupport.ResponseContent)
            isValid = be.notify('Phản hồi không được bỏ trống!!!', "", 'error');
    ...
    function registerControls() {
        ...
        CKEDITOR.replace('txtResponseContent', {});
    ...
    function loadDetails(e, id) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                CKEDITOR.instances.txtRequestContent.setData(response.RequestContent);
                CKEDITOR.instances.txtResponseContent.setData(response.ResponseContent);
    ...
    function resetFormMaintainance() {
        ...
        CKEDITOR.instances.txtResponseContent.setData('');
    }
