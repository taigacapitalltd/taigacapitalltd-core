    ...
    var e = window.StyleFix = {
        link: function (t) {
            ...
            var r = t.href || t.getAttribute("data-href"), i = r.replace(/[^\/]+$/, ""),
                s = t.parentNode, o = new XMLHttpRequest, u; o.onreadystatechange = function () {
                o.readyState === 4 && u()
            };
            u = function () {
            ...
            var n = t.getAttribute("style"); n = e.fix(n, !1, t);
...
(function (e) {
    ...
    var n = window.PrefixFree = {
        prefixCSS: function (e, r, i) {
            ...
            n.functions.indexOf("linear-gradient") > -1 && (e = e.replace(/(\s|:|,)(repeating-)?linear-gradient\(\s*(-?\d*\.?\d*)deg/ig,
                function (e, t, n, r) { return t + (n || "") + "linear-gradient(" + (90 - r) + "deg" }));
            ...
            if (n.properties.length) {
                ...
                e = t("valueProperties", "\\b", ":(.+?);",
                    function (e) { return e.replace(o, s + "$1") }, e)
            } if (r) {
    ...
    (function () {
        ...
        var t = {
            ...
            box: "display", flexbox: "display", "inline-flexbox": "display",
        ...
        var i = e.appendChild(document.createElement("style")); for (var o in t) {
            var u = o + (t[o] ? "(" + t[o] + ")" : "");
