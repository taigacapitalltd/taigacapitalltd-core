var MenuItemController = function () {
    ...
    function ValidateData() {
        ...
        if (!data.MenuGroupId)
            isValid = be.notify('Menu group không được bỏ trống!!!', "", 'error');

        if (!data.FunctionId)
            isValid = be.notify('Chức năng không được bỏ trống!!!', "", 'error');
    ...
    function createData(data) {
        $.ajax({
            ...
            success: function (response) {
                ...
                be.notify('Thêm menu item thành công!!!', "", 'success');
        ...
        $("div#jstree").jstree({
            ...
            table: {
                columns: [
                    ...
                    {
                        header: "Chức năng", value: "functionName",
                        format: function (v) {
                            if (v) {
                                return '<span>' + v + '</span >'
                            }
