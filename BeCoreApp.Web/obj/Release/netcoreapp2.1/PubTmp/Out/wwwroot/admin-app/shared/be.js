var be = {
    ...
    getEmailConfirmed: function (status) {
        ...
        if (status == true)
            ...
            return '<span class="badge badge-secondary-light">Chưa Kích Hoạt</span>';
    },
    ...
    getKYCType: function (type) {
        if (type == 1)
            return '<span class="badge badge-primary-light">Chờ Duyệt</span>';
        else if (type == 2)
            return '<span class="badge badge-danger-light">Từ Chối</span>';
        else if (type == 3)
            return '<span class="badge badge-success-light">Chấp Nhận</span>';
        else
            return '<span class="badge badge-secondary-light">Khóa</span>';
    },
